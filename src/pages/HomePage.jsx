...
const MENU_LEFT = [
  ...
  },
  {
    ...
    items: [
      { name: "Palak Chaat", price: "14", desc: "crispy spinach | yogurt | tamarind" },
      { name: "Multigrain Sev Puri", price: "12", desc: "spiced potato | avocado | green chutney | pomegranate" },
      { name: "Samosa (2pc)", price: "10", desc: "potato | peas | mint chutney | tamarind chutney" },
      { name: "Vada Pav", price: "14", desc: "spiced potato | curry leaves | garlic chutney | buns" },
      { name: "Dahi Ke Kebab", price: "16", desc: "hung yogurt | herbs | vermicelli" },
...
const MENU_RIGHT = [
  ...
  },
  {
    ...
    items: [
      { name: "Saag Paneer", price: "20", desc: "spinach | garlic | cream" },
      { name: "Kadhai Paneer", price: "20", desc: "spicy tomato sauce | onions | bell peppers" },
      { name: "Vegetable Biryani", price: "20", desc: "yogurt | green chili | garam masala" },
      { name: "Mangalorean Fish Curry", price: "25", desc: "kingfish | tamarind | coastal spices" },
